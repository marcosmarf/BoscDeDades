...
void display_debug(const String& text1, const String& text2) {
  ...
  u8g2.drawStr(0, 12, text1.c_str());
  u8g2.drawStr(0, 24, text2.c_str());
  u8g2.sendBuffer();
}
...
static void display_values()
{
	...
	if (cfg::has_display)
	{
		...
		// Header centered
		u8g2.drawStr(20, 10, display_header.c_str());

		// Lines
		u8g2.drawStr(0, 25, display_lines[0].c_str());
		u8g2.drawStr(0, 37, display_lines[1].c_str());
		u8g2.drawStr(0, 49, display_lines[2].c_str());

		// Footer
		String footer = displayGenerateFooter(screen_count);
		u8g2.drawStr(20, 62, footer.c_str());
