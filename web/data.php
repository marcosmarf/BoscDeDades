<?php
// =============================================================
//  BoscDeDades — data.php  v2
//  Receptor universal de datos airRohr (todos los sensores)
//  - Guarda datos en sensor_data
//  - Registra cada intento en send_log (para diagnóstico)
//  - Captura headers HTTP X-Sensor, X-MAC-ID, X-PIN
// =============================================================

// ── Configuración de la base de datos ────────────────────────
define('DB_HOST', 'localhost');
define('DB_NAME', 'boscdedades_sensors');   // ← cambia esto
define('DB_USER', 'boscdedades_user');      // ← cambia esto
...
// ── Leer headers que manda el firmware ───────────────────────
//    User-Agent:  NRZ-2024-135/<chipid>/<mac>
//    X-Sensor:    esp8266-<chipid>
//    X-MAC-ID:    esp8266-<mac>
//    X-PIN:       <pin number>
...
// ── Conectar a la base de datos (necesario tanto para ok como para log de errores) ──
try {
    $pdo = new PDO(
...
// ── Función auxiliar: registrar en send_log ───────────────────
...
// ── Mapeo completo value_type → columna de sensor_data ───────
//    Clave  = value_type exacto que manda el firmware
//    Valor  = nombre de columna en la tabla
const FIELD_MAP = [
...
// ── Campos de texto (no se castean a float) ───────────────────
const STRING_COLS = ['gps_timestamp'];

// ── Construir el array de columnas a insertar ─────────────────
...
// ── INSERT dinámico en sensor_data ────────────────────────────
try {
    ...
    http_response_code(500);
    echo json_encode(['status' => 'error', 'reason' => 'db_error']);
}
?>